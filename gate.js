...
function initAuthGate(onSignedIn) {
  ...
  try {
    ...
    errorEl.textContent = "Erreur technique au chargement de Firebase Auth : " + err.message + ". Vérifie que firebase-auth-compat.js est bien chargé avant shared/gate.js.";
    console.error(err);
  }
}
